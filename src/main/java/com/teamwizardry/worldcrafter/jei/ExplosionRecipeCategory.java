...
public class ExplosionRecipeCategory extends BaseRecipeCategory<ExplosionRecipe>
{
    public ExplosionRecipeCategory(IGuiHelper guiHelper)
    {
        super(guiHelper,
              ...
              I18n.format("worldcrafter.jei.explosionRecipe"),
              guiHelper.createDrawableIngredient(new ItemStack(Blocks.TNT)));
    }
    
    @Override public Class<? extends ExplosionRecipe> getRecipeClass() { return ExplosionRecipe.class; }
    
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, ExplosionRecipe recipe, IIngredients ingredients)
    {
